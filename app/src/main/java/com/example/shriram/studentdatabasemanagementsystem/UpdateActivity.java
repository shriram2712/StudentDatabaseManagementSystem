...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button update, reset , logout, back;
    DatabaseHelper db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try
                {
                    ...
                    {
                        Toast.makeText(UpdateActivity.this, "Please enter ptr less than or equal to 10", Toast.LENGTH_SHORT).show();
                    }
                }
                catch (NumberFormatException ne)
                {
                    Toast.makeText(UpdateActivity.this, "Please enter valid values", Toast.LENGTH_SHORT).show();
                }

                Boolean result = db.updateStudent(nm, dv, em, ph, add, sem1, sem2, sem3, sem4, sem5 );

                if(result == true)
                    Toast.makeText(UpdateActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(UpdateActivity.this, "Update issue", Toast.LENGTH_SHORT).show();
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent(UpdateActivity.this, FirstPage.class);
                startActivity(i);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent(UpdateActivity.this, AdminWelcomePage.class);
                startActivity(i);
                finish();
            }
        });
