...
public class ViewC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(res!= null && res.getCount()>0){
                    ...
                    Toast.makeText(ViewC.this, "Data retrieved successfully", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ViewC.this, "No Data Found",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(ViewC.this, FirstPage.class);
                startActivity(it);
                finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(ViewC.this, View1.class);
                startActivity(it);
                finish();
            }
        });
